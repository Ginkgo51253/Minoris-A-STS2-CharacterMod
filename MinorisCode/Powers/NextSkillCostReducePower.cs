...
/*
能力中文名称: 技能减费
能力英文名称: Next Skill Cost Reduce
能力描述(ZHS): 本回合中，你下一张技能牌的费用减少[blue]{Amount}[/blue]点。然后移除。回合结束时移除。
能力描述(ENG): This turn, your next Skill costs [blue]{Amount}[/blue] less. Then remove this. Remove at end of turn.
相关卡牌（本地键）: MINORIS-CARD007_SPIN_STRIKE
*/
